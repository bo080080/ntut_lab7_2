...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rabbit_seekBar = (SeekBar) findViewById(R.id.rabbit);
        turtle_seekBar = (SeekBar) findViewById(R.id.turtle);
    ...
    private Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            if (rabbit_count >= 100)
                if (turtle_count < 100)
                    Toast.makeText(MainActivity.this, "烏龜獲勝", Toast.LENGTH_SHORT).show();
        }
    };
    private void runAsyncTsak(){
        new AsyncTask<Void ,Integer, Boolean>() {
            ...
            protected void onPostExecute(Boolean status){
                if(rabbit_count<100)
                    Toast.makeText(MainActivity.this,"兔子獲勝",Toast.LENGTH_LONG).show();
            }
        }.execute();
    }
